...
var plutoniumCell = new TitleCell("plutonium indistries", 12, 15000);
var cineEssexCell = new TitleCell("cinema essex", 13, 14000);
var texacoCell = new TitleCell("texaco", 14, 16000);
